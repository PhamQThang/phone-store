...
export function WarrantyRequestForm({
  ...
  initialData,
  isLoading,
}: WarrantyRequestFormProps) {
  const form = useForm<z.infer<typeof warrantyRequestStatusSchema>>({
    resolver: zodResolver(warrantyRequestStatusSchema),
    defaultValues: {
  ...
  const handleSubmit = async (
    values: z.infer<typeof warrantyRequestStatusSchema>
  ) => {
    try {
